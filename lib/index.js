...
function hypot( a, b, options ) {
	...
	// if copy, create new ndarray with same underlying data store
	// if not copy, create a new ndarray array using `a`'s underlying data store (same shape, strides, etc)
